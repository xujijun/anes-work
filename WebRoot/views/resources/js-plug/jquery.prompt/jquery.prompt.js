(function (T) {
    T.extend({
        prompt: function (options) {
            ...
            var _okBtn = options._okBtn||"确定";
            var _cancleBtn = options._cancleBtn||"取消";
            /*options = {
                        ...
                        '<div class="modal-content">' +
                            '<div class="modal-header m-common-bg">' +
                                ...
                                '<div class="modal-body" style="text-align: center;">' +
                                    ...
                                    '<div class="butt">' +
                                        '<button class="but but_ok">'+_okBtn+'</button><button class="but cancel but_close">'+_cancleBtn+'</button>' +
                                    '</div>' +
                                '</div>' +
                            '<div class="modal-footer"><input type="hidden" id="parm_val" /></div>' +
                        '</div>' +
