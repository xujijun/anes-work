...
public class ExcelUtil {
	...
	public static <E> void exportExcel(String fileName, Workbook wb, HttpServletRequest request, HttpServletResponse response)	{
		response.setContentType("application/ms-excel");
		// 使用URLEncoder避免中文乱码：
		String agent = (String) request.getHeader("USER-AGENT");
		try {
			if (agent != null && agent.contains("Firefox")) { // 如果是火狐浏览器
